...
export function loadStoryState() {
  ...
  try {
    ...
    return {
      ...
      missedOpportunities: parsed.missedOpportunities ?? parsed.missedMoments ?? [],
      consequenceThreads: parsed.consequenceThreads ?? [],
      relationshipMoments: parsed.relationshipMoments ?? [],
      turningPoints: parsed.turningPoints ?? [],
      repeatedPatterns: parsed.repeatedPatterns ?? [],
      endingSeeds: parsed.endingSeeds ?? [],
